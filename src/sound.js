const initSound = () => {
  ...
  const startStory = new Audio();
  const newMap = new Audio();
  ...
  middleLevelClear.src = "./audio/getSeal.mp3";
  ...
  startStory.src = "./audio/startStory.mp3";
  newMap.src = "./audio/newMap.mp3";

  startStory.volume = 0.7;
  newMap.volume = 0.7;
  ...
  globalAudio.startStory = startStory;
  globalAudio.newMap = newMap;
};
initSound();
